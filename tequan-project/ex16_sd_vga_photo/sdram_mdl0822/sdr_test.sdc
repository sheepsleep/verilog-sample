...
create_clock -name {virl_clk} -period 20.000 -waveform { 0.000 10.000 } 
...
set_input_delay -add_delay -max -clock [get_clocks {virl_clk}]  14.000 [get_ports {spi_miso}]
set_input_delay -add_delay -min -clock [get_clocks {virl_clk}]  0.500 [get_ports {spi_miso}]
...
set_output_delay -add_delay -max -clock [get_clocks {virl_clk}]  8.500 [get_ports {spi_clk}]
set_output_delay -add_delay -min -clock [get_clocks {virl_clk}]  -1.500 [get_ports {spi_clk}]
set_output_delay -add_delay -max -clock [get_clocks {virl_clk}]  8.500 [get_ports {spi_cs_n}]
set_output_delay -add_delay -min -clock [get_clocks {virl_clk}]  -1.500 [get_ports {spi_cs_n}]
set_output_delay -add_delay -max -clock [get_clocks {virl_clk}]  8.500 [get_ports {spi_mosi}]
set_output_delay -add_delay -min -clock [get_clocks {virl_clk}]  -1.500 [get_ports {spi_mosi}]
...
set_multicycle_path -setup -end -from  [get_clocks {sys_ctrl:uut_sysctrl|PLL_ctrl:uut_PLL_ctrl|altpll:altpll_component|_clk1}]  -to  [get_clocks {sys_ctrl:uut_sysctrl|PLL_ctrl:uut_PLL_ctrl|altpll:altpll_component|_clk0}] 2
set_multicycle_path -hold -end -from  [get_clocks {sys_ctrl:uut_sysctrl|PLL_ctrl:uut_PLL_ctrl|altpll:altpll_component|_clk1}]  -to  [get_clocks {sys_ctrl:uut_sysctrl|PLL_ctrl:uut_PLL_ctrl|altpll:altpll_component|_clk0}] 1
