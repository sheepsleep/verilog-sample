...
# d:\2.3\Nios\ucos\hello_ucos_0\hello_ucos_0_syslib\..\..\nios_ucos.ptf
#
# Generated: 2011-10-01 02:14:43.5
...
QUARTUS_PROJECT_DIR = D:/2.3/Nios/ucos
...
$(QUARTUS_PROJECT_DIR)/onchip_ROM.hex: $(ELF)
	...
	elf2hex $(ELF) 0x00008000 0x87FF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_ROM.hex --create-lanes=0

$(QUARTUS_PROJECT_DIR)/onchip_RAM.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x00010000 0x103FF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_RAM.hex --create-lanes=0
